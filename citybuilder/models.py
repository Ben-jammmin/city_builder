...
class Tool(Enum):
    ...
    HIGHRISE_RESIDENTIAL = "highrise_residential"
    COMMERCIAL = "commercial"
    DENSE_COMMERCIAL = "dense_commercial"
    HIGHRISE_COMMERCIAL = "highrise_commercial"
    INDUSTRIAL = "industrial"
    ROAD = "road"
...
VIEW_LABELS = {
    ...
    ViewMode.TRAFFIC:    "Traffic",
    ViewMode.LAND_VALUE: "Land Value",
    ViewMode.POLLUTION:  "Pollution",
}
...
TOOL_LABELS = {
    ...
    Tool.HIGHRISE_RESIDENTIAL: "Highrise Residential",
    Tool.COMMERCIAL: "Commercial",
    Tool.DENSE_COMMERCIAL: "Dense Commercial",
    Tool.HIGHRISE_COMMERCIAL: "Highrise Commercial",
...
MENU_TOOLS = {
    "Zones": [
        ...
        Tool.HIGHRISE_RESIDENTIAL,
        Tool.COMMERCIAL,
        Tool.DENSE_COMMERCIAL,
        Tool.HIGHRISE_COMMERCIAL,
        Tool.INDUSTRIAL,
        Tool.BULLDOZE,
    ],
    "Recreation": [
...
TOOL_TO_ZONE = {
    ...
    Tool.HIGHRISE_RESIDENTIAL: (ZoneType.RESIDENTIAL, 3),
    Tool.COMMERCIAL: (ZoneType.COMMERCIAL, 1),
    Tool.DENSE_COMMERCIAL: (ZoneType.COMMERCIAL, 2),
    Tool.HIGHRISE_COMMERCIAL: (ZoneType.COMMERCIAL, 3),
...
class Tile:
    ...
    pollution: float = 0.0        # 0.0-1.0; raised by industrial zones, spreads to neighbors
    on_fire: bool = False
