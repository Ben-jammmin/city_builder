...
def stats_to_data(stats: CityStats) -> dict[str, Any]:
    ...
    return {
        ...
        "approval_rating": stats.approval_rating,
        "months_in_deficit": stats.months_in_deficit,
        "prev_demand_residential": stats.prev_demand_residential,
        "prev_demand_commercial": stats.prev_demand_commercial,
        "prev_demand_industrial": stats.prev_demand_industrial,
        "bonds": stats.bonds,
        "exp_bonds": stats.exp_bonds,
        "active_ordinances": stats.active_ordinances,
        "messages": stats.messages,
        "budget_history": stats.budget_history,
        "population_history": stats.population_history,
        "demand_history": stats.demand_history,
...
def stats_from_data(data: dict[str, Any]) -> CityStats:
    ...
    return CityStats(
        ...
        approval_rating=data.get("approval_rating", 75),
        months_in_deficit=data.get("months_in_deficit", 0),
        prev_demand_residential=data.get("prev_demand_residential", 50),
        prev_demand_commercial=data.get("prev_demand_commercial", 50),
        prev_demand_industrial=data.get("prev_demand_industrial", 50),
        bonds=data.get("bonds", []),
        exp_bonds=data.get("exp_bonds", 0),
        active_ordinances=data.get("active_ordinances", []),
